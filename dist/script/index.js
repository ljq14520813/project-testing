...
var $tmNum = $('.tmNum');
var noticeTimer = null; // var notice_this=null;

$nav_list.children().on('click', function () {
  index = $(this).index(); // console.log($(this).index());
...
function autoPlay() {
  if (index === 5) {
    index = 1;
    $img_list.css("left", 0); // $img_list.attr('style','left:0px');
  } else {
    index++;
  }
...
function tmAutoPlay() {
  if (tIndex === 6) {
    tIndex = 1;
    $tmImgList.css("left", 0); // $tmImgList.attr('style','left:0px');
  } else {
    tIndex++;
  }
...
$(function () {
  function mainList_load(json) {
    $.each(json, function (index, item) {
      var str = "<li><a href=\"#\">".concat(item.cb1, "</a>/<a href=\"#\">").concat(item.cb2, "</a>/<a href=\"#\">").concat(item.cb3, "</a><i class=\"iconfont icon-youjiantou\"></i></li>");
  ...
  function goods_load(json) {
    $.each(json, function (index, item) {
      var str = "<li> <a href=\"./goodsDetails.html?dataID=".concat(item.dataID, "\"><div class=\"goods_img_wrap\"><img src=\"").concat(item.url, "\" alt=\"\" class=\"goods_img\"></div><div class=\"goods_info\"><h4>").concat(item.title, "</h4><p>").concat(item.info, "</p><p class=\"saygood\"><i class=\"iconfont icon-xiaolian\"></i><i class=\"g_num\">").concat(item.saygood, "</i> \u4EBA\u8BF4\u597D</p></div></a></li>");
  ...
  function shopping_load(json) {
    $.each(json, function (index, item) {
      var str = "<li><a href=\"./goodsDetails.html?dataID=".concat(item.dataID, "\"><div class=\"shopping_img_wrap\"><img src=\"").concat(item.url, "\" alt=\"\"></div><div class=\"shopping_info\"><p class=\"shopping_subtitle\"><i class=\"iconfont icon-yinhao\"></i>").concat(item.title, "</p><div class=\"shopping_member\"><div class=\"member_img_wrap\"><img src=\"../imgs/member_item.jpg\" alt=\"\"></div><p class=\"member_name\">").concat(item.name, "</p></div></div></a></li>");
