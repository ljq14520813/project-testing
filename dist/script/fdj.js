...
(function () {
  ...
  function createMin(parent) {
    min = Utils("div", {
      ...
      width: MIN_WIDTH + "px",
      height: MIN_WIDTH + "px",
      backgroundImage: "url(../imgs/".concat(frist, ")"),
  ...
  function createImageCon(parent) {
    ...
    for (var i = 0; i < iconList.length; i++) {
      var img = Utils("img", {
        ...
        border: "2px solid rgba(255,68,0,".concat(i == 0 ? 1 : 0, ")"),
  ...
  function iconMouseHandler(e) {
    ...
    if (preImg) {
      preImg.style.border = "2px solid rgba(255,68,0,0)";
    }

    preImg = e.target;
    preImg.style.border = "2px solid rgba(255,68,0,1)"; //    console.log( e.target.src.replace("_icon",""));
