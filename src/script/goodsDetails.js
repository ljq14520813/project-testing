...
function getDOM(item){
    var strimg1=`<a href="#" class="show"><img src="../imgs/${item.imgUrl2.split(',')[0]}" alt=""></a>`;
    var strimg2=`<li class="selected"><a href="#"><img src="../imgs/${item.imgUrl.split(',')[0]}" alt=""></a></li>`;
    var strimg3=`<li class="active"><img src="../imgs/${item.imgUrl3.split(',')[0]}" alt=""></li>`;
    var mask='<div class="mask"></div>';
    for(var i=1,len=item.imgUrl.split(',').length;i<len;i++){
        strimg1+=`<a href="#"><img src="../imgs/${item.imgUrl2.split(',')[i]}" alt=""></a>`;
        strimg2+=`<li><a href="#"><img src="../imgs/${item.imgUrl.split(',')[i]}" alt=""></a></li>`;
        strimg3+=`<li><img src="../imgs/${item.imgUrl3.split(',')[i]}" alt=""></li>`;
    }
